...
import 'package:waffir/features/decouvrir/controlers/Decouvre_controller.dart';
...
final List<String> banners ;
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(decController());
    return Column(
      children: [
        CarouselSlider(
              ...
              children: [
               for( int i = 0 ; i<banners.length ; i++)
                 CircularContainer(
                  ...
                  backgroundColor: controller.carouselCurrentIndex.value == i ? TColors.primary :  TColors.primary.withOpacity(0.3), 
