...
import 'package:waffir/features/authentification/screens/signup.widgets/succes_screen.dart';
...
SizedBox(width: double.infinity, child: ElevatedButton(onPressed: ()  { _verified_mail();},child : const Text(TTexts.tContinue))),
const SizedBox(height: TSizes.spaceBtwItems,),
SizedBox(width: double.infinity, child: OutlinedButton(onPressed: (){ _resend_verified_mail();},child : const Text(TTexts.resendEmail))),
